...
--
- Built into the NHST framework is the acceptance of a proportion of tests being false positive ($\alpha$), the likelihood of getting false positives increases with the number of tests.
