...
1. [Install R and R Studio](lesson_1_installation.html) and get it started
2. Create a report from R using [these notes](lesson_2_markdown.html)
3. Start a [Project](lesson_3_structure.html)
